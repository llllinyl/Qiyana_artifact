...
echo "============================================="
echo "🔧  Client-to-Server Baseline Test (With Logs)"
echo "============================================="
...
RUSTFLAGS="-C target-cpu=native" cargo run --release --bin baseline_server > ./result/result_single_server.txt 2>&1 &
SERVER_PID=$!
...
echo "================ CLIENT OUTPUT ================"
RUSTFLAGS="-C target-cpu=native" cargo run --release --bin baseline_client 2>&1 | tee ./result/result_single_client.txt
CLIENT_EXIT=$?
echo "================ CLIENT ENDED ================="
