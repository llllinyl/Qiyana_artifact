...
qiyana02   = np.array([1783.43, 6926.30, 31814.25, 127545.84]) 
qiyana12   = np.array([1070.68, 4255.29, 17220.62, 70313.37]) 
...
for i in range(len(x_pos)):
    ...
    total_qiyana0 = qiyana01[i] + qiyana02[i]
    ratio_qiyana0 = max_val / total_qiyana0
    ax2.text(x_qiyana0[i] + 0.14, total_qiyana0 * 1.35, f'{ratio_qiyana0:.1f}' + r'$\times$', 
             ha='center', va='bottom', fontsize=12, family='Times New Roman',fontweight='bold')
    
    total_qiyana1 = qiyana11[i] + qiyana12[i]
    ratio_qiyana1 = max_val / total_qiyana1
    ax2.text(x_qiyana1[i] + 0.16, total_qiyana1 * 0.95, f'{ratio_qiyana1:.1f}' + r'$\times$', 
             ha='center', va='bottom', fontsize=12, family='Times New Roman',fontweight='bold')
