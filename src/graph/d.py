...
# (A OR B OR C) AND D AND NOT (E OR F) AND G AND H
config = {
    "font.family": 'serif',
...
baseline2  = np.array([42293.47, 172327.74, 674564.43, 2668806.49]) 
qiyana2   = np.array([1783.43, 6926.30, 31814.25, 127545.84]) 
qiyanawosel2   = np.array([1070.68, 4255.29, 17220.62, 70313.37]) 
...
plt.savefig('d.pdf', dpi=600, bbox_inches='tight')
plt.show()