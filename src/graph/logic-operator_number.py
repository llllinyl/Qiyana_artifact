...
qiyana0_and = [925.02, 922.49, 926.78]
qiyana1_and = [134.97+3.78, 137.88+3.78, 136.55+3.78]

baseline_or = [10450.67+3.78, 15401.97+3.78, 20388.71+3.78]
qiyana0_or = [1157.88, 1404.11, 1610.51]
qiyana1_or = [364.23+3.78, 591.23+3.78, 844.98+3.78]

comm_x = [1, 2, 3, 4, 5, 6]
comm_baseline = [262.77, 264.78, 266.79, 262.77, 264.78, 266.79]
comm_qiyana0 = [13.29, 13.29, 13.29, 21.58, 29.87, 38.16]
comm_qiyana1 = [142.04, 142.04, 142.04, 150.33, 158.62, 166.91]
...
add_ratio_arrow(ax1, 1, qiyana0_and[0], baseline_and[0], offset_x=-0.03)
add_ratio_arrow(ax1, 1, qiyana1_and[0], baseline_and[0], offset_x=0.03)

add_ratio_arrow(ax1, 3, qiyana0_and[2], baseline_and[2], offset_x=-0.03)
add_ratio_arrow(ax1, 3, qiyana1_and[2], baseline_and[2], offset_x=0.03)

add_ratio_arrow(ax1, 4, qiyana0_or[0], baseline_or[0], offset_x=-0.03)
add_ratio_arrow(ax1, 4, qiyana1_or[0], baseline_or[0], offset_x=0.03)

add_ratio_arrow(ax1, 6, qiyana0_or[2], baseline_or[2], offset_x=-0.03)
add_ratio_arrow(ax1, 6, qiyana1_or[2], baseline_or[2], offset_x=0.03)
...
x_qiyana1 = x_positions + bar_width * 1.25
...
bars2 = ax2.bar(x_qiyana, comm_qiyana0, width=bar_width, color=myblue, 
                edgecolor='black', linewidth=0.5, alpha=0.7, label='Comm-Qiyana', zorder=1)

bars3 = ax2.bar(x_qiyana1, comm_qiyana1, width=bar_width, color=myyellow, 
                edgecolor='black', linewidth=0.5, alpha=0.7, label='Comm-Qiyana-1', zorder=1)

from matplotlib.lines import Line2D
legend_elements = [
    Line2D([0], [0], color=c_baseline, lw=1, marker='o', markersize=2, label='Baseline'),
    Line2D([0], [0], color=c_qiyana0, lw=1, marker='x', markersize=2, label='Qiyana'+ r'$_0$'),
    Line2D([0], [0], color=c_qiyana1, lw=1, marker='*', markersize=2, label='Qiyana'+ r'$_1$'),
]
...
legend_elements2 = [
    ...
    plt.Rectangle((0,0),1,1, facecolor=myblue, edgecolor='black', linewidth=0.4, label='Qiyana'+ r'$_0$'),
    plt.Rectangle((0,0),1,1, facecolor=myyellow, edgecolor='black', linewidth=0.4, label='Qiyana'+ r'$_1$'),
]
