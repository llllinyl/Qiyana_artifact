...
qiyana2   = np.array([783.43, 3141.68, 13121.27, 50602.35]) 
qiyanawosel2   = np.array([98.40, 393.31, 1615.89, 6288.92])
...
for i in range(len(x_pos)):
    ...
    ax2.text(x_qiyana[i] + 0.08, total_qiyana * 1.1, f'{ratio_qiyana:.1f}' + r'$\times$', 
    ...
    ax2.text(x_qiyanawosel[i] + 0.12, total_qiyanawosel * 1.1, f'{ratio_qiyanawosel:.1f}' + r'$\times$', 
             ha='center', va='bottom', fontsize=10, family='Times New Roman',fontweight='bold')
...
ax1.set_yticklabels(['$10$', '$10^2$', '$10^3$', '$10^4$', '$10^5$'], fontsize=8)
