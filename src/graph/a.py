...
baselineh2 = np.array([4064.25, 16118.86, 64059.28, 256635.44]) 
...
for i in range(len(x_pos)):
    ...
    ax2.text(x_qiyana1[i] + 0.18, values[4], f'{ratio_qiyana1:.1f}' + r'$\times$', 
             ha='center', va='bottom', fontsize=11, family='Times New Roman',fontweight='bold')
...
ax2.legend(handles=legend_elements, ncol=3, loc='upper right',fontsize=10,
    frameon=True,framealpha=0.95,bbox_to_anchor=(0.99, 1.02), columnspacing=0.2,
